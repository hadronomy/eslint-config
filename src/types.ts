...
export interface OptionsVue extends OptionsOverrides {
   ...
   *
   * @see https://github.com/hadronomy/eslint-processor-vue-blocks
   * @default true
   */
...
export interface OptionsConfig extends OptionsComponentExts, OptionsProjectType {
   ...
   *
   * @see https://github.com/hadronomy/eslint-config-flat-gitignore
   * @default true
   */
   ...
   *
   * Including:
   * - `hadronomy/top-level-function`
   * - `hadronomy/if-newline`
   *
   * @default false
   */
