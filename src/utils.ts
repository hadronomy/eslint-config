...
const isCwdInScope = isPackageExists('@hadronomy/eslint-config');
 ...
 * @example
 * ```ts
 * import { renameRules } from '@hadronomy/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@hadronomy/eslint-config'
